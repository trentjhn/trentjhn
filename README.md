...
I spent 18 months as a Technical PM at PayPal, then built a set of AI-native systems for my own workflows: a [session-aware trading OS](https://github.com/trentjhn/trading-os), a [knowledge management system for AI](https://github.com/trentjhn/AI-Knowledgebase), an [Zenkai (AI learning platform)](https://github.com/trentjhn/zenkai). The methodology running through all of them is documented in my public knowledge base.
